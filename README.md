...
- [MemorySync](https://github.com/memorysyncio/memorysync-cursor-starter): Persistent, multi-tenant memory layer and remote MCP server for LangChain & LangGraph agents with deterministic state recall. ![GitHub Repo stars](https://img.shields.io/github/stars/memorysyncio/memorysync-cursor-starter?style=social)
